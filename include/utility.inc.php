...
/**
 * Imposta il main per il template di SASH.
 *
 * @return Template
 */
function setupMainSash(): Template
{
    $main = new Template($_SERVER['DOCUMENT_ROOT'] . "/skins/admin/sash/dtml/views/main.html");
    // Default set delle parti statiche per il template sash
...
/**
 * Imposta il main per il template di WIZYM.
 *
 * @return Template
 */
function setupMainWizym(): Template
{
    checkSession();
